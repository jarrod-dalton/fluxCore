...
#' Entity$update() expects a named list of scalar changes. set_vars()
#' converts vectors into the expected named-list format.
#'
...
#'
#' Convert a named vector into a named list suitable for returning from transition().
#' Optionally select and order a subset via vars.
#'
